...
// cookie.textContent='we use cookie for improved functionality and analytic'
cookie.innerHTML =
  "we use cookie for improved functionality and analytic <button class='btn btn--close-cookie'>Got it!</button>";
...
// determine whaat element originated the event
...
// //   e.target.closest('.nav').querySelectorAll('.nav__link').forEach(el => { if (el !== e.target) el.style.opacity = 1;
